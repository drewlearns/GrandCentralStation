...
exports.handler = async (event) => {
  try {
    ...
    const { authorizationToken, householdId, category, billName, amount, dayOfMonth, frequency, isDebt, interestRate, cashBack, description, status, url, username, password, ipAddress, deviceDetails } = body;
